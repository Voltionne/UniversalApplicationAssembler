...
#                 self._parse_one_level(yaml_config)
...
#             self.definitions[key] = (definition, _Value())
#             self.definitions[key][1].create_from_definition(definition)
...
#                     assert isinstance(instruction, dict), f"Expected each instruction to be a dictionary, not a {type(instruction)}!"
...
#         assert "name" in instruction, f"Instruction has to have a name at least!"

#         if "parameters" in instruction: #this instruction takes parameters
#             pass
#         else:
#             pass
